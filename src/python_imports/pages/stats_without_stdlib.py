...
class StatsWithoutStdlib(Page):
    ...
    import_stats_df_path = DATA_FOLDER / 'exclude_stdlib' / 'import_stats.csv'
    import_stats_by_package_df_path = DATA_FOLDER / 'exclude_stdlib' / 'import_stats_by_package.csv'
    key = 'all'
