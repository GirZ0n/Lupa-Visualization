...
if __name__ == '__main__':
    ...
    show_page(
        ...
        import_stats_by_version=get_stats_by_name(DATA_FOLDER / 'all' / 'import_stats'),
        package_stats_by_version=get_stats_by_name(DATA_FOLDER / 'all' / 'import_stats_by_package'),
        key='all',
    )
